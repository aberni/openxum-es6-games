...
class Engine extends OpenXum.Engine {
    ...
    //return this._board.get_move_test(this._currentColor);
        // Retourne la liste de tous les coups possibles
        // La liste retournée doit être un tableau d'objet Move.
        let tab=new Array();
        tab.push(new Move(49,0));
        tab.push(new Move(0,1));
        tab.push(new Move(1,2));
        tab.push(new Move(2,3));
        tab.push(new Move(3,4));
        return tab;
    }
    ...
    move(move) {
        ...
        tab=this._board.get_move(this._currentColor);
        //if(tab.length<1) {
        this.changePlayer();
        //}
