...
/////////////////////
    ...
    _board_ok(){ // TO DO
        ...
        for(let i=0;i<49;i+=1){
            if(!this._flag[i]) {
                ...
                console.log(this._flag);
                console.log(flag);
                console.log(new_count_flag);
                console.log(new_count_flag-flag);
    ...
    _too_much_friend(i){
        ...
        console.log("color du jeton courant");
        console.log(color);
        for(let r=0;r<6;r+=1) {
            let id=this._get_one_move(color, tr_mat[r]);
            console.log("ID DE LA CASE VISITE");
            console.log(id);
            if(is_valid(id) && !this._flag[id]){
                console.log("CETTE CASE EST UNE BONNE CASE :)");
