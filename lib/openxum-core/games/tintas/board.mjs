...
// public methods
    ...
    apply_move(move){ // Apply the move to the board
        ...
        if(is_valid(this._id_pawn)) {
            ...
            console.log("empty:");
            console.log(this._board[this._id_pawn].get_color());
        }
        this._board[move.get_to()].set_color(8);
        console.log("pawn:");
        console.log(this._board[move.get_to()]);
    ...
    init_board_test2(){ // test 2
        ...
        let tab1=this.get_move_test(7); // 10 36 37 21 05
        let tab2=this.get_move_test(3); // 37 21 50
        let tab3=this.get_move_test(5); // vide
    ...
    init_board_test3(){ // test 2
        ...
        let tab1=this.get_move_test(7); // 42 37 31
        let tab2=this.get_move_test(2); // 42 50
        let tab3=this.get_move_test(4); // vide
    ...
    init_board_test4(){ // test 4
        ...
        let tab1=this.get_move_test(7); // 14 27 45 41 06 01
        let tab2=this.get_move_test(3); // 14 27 50
        let tab3=this.get_move_test(6); // vide
    ...
    init_board_test5(){ // test 5
        ...
        let tab1=this.get_move_test(7); // 00 02 04 05 10 11 13 17 22 24 25 26 33 34 35 36 38 42 43 44 48
        let tab2=this.get_move_test(5); // vide
