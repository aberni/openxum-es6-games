...
class Engine extends OpenXum.Engine
{
    ...
    move(move) {
        if(move.getType()===MoveType.PUT_PIECE){
            ...
            if(move.getPiece()===0){
                ...
                this._towers[index_tower_to].pieces.splice(move.getPiece());
            }
    ...
    _add_reserve(pieces){
        ...
        console.log("a", "b", this._black_piece_amount, "w", this._white_piece_amount);
    }
    ...
    _remove_piece_from_reserve()
    {
        ...
        console.log("r","b", this._black_piece_amount, "w", this._white_piece_amount);
    }
