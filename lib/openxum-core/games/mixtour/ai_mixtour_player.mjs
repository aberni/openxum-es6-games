...
// public methods
  ...
  _compute_eval_value(engine, white_mult, black_mult) {
    ...
    if (engine.is_finished()) {
      ...
      let _size_white_controlled_towers = this._compute_sum_size_controlled_towers(engine.getTowers(), Color.WHITE);
      let _size_black_controlled_towers = this._compute_sum_size_controlled_towers(engine.getTowers(), Color.BLACK);
