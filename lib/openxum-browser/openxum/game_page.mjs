...
// private methods
  ...
  build_opponent() {
    if (this._game_type === GameType.REMOTE_AI) {
      this._opponent = new this._namespace.RestWebServicePlayer(this._opponent_color, this._engine, username, 'http://127.0.0.1/openxum-ws-php/index.php/');
...
//      } else {
        this._opponent = new this._root.RandomPlayer(this._opponent_color, this._engine);
//      }
