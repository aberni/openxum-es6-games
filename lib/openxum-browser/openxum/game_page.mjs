...
class GamePage {
  constructor(root, namespace, name, first_color, color, opponent_color, game_type, game_id,
              mode, username, owner_id, opponent_id, replay, ai, winner) {
    this._root = root;
...
// private methods
  ...
  build_manager(winner) {
    this._manager = new this._namespace.Manager(this._engine, this._gui, this._opponent,
      new this._root.Status(document.getElementById("status")), winner);
  }
