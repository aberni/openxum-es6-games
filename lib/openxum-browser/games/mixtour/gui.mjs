...
class Gui extends OpenXum.Gui {
    ...
    _draw_text() {
        ...
        this._context.fillText("points :  black : " + this._engine.get_black_points() + "  white : " + this._engine.get_white_points(), this._offsetX, this._offsetY / 2);
        this._context.fillText("remaining pieces : black : " + this._engine.get_black_piece_amount() + "  white : " + this._engine.get_white_piece_amount(), this._offsetX + 3 * this._deltaX, this._offsetY / 2);
    }
