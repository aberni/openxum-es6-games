...
class Gui extends OpenXum.Gui {
    ...
    _draw_text(){
        ...
        //TODO: replace by getters
        const black_pts=this._engine._black_points;
        const white_pts=this._engine._white_points;
        const black_pieces=this._engine._black_piece_amount;
        const white_pieces=this._engine._white_piece_amount;
        this._context.fillText("points :  black : " + black_pts + "  white : " + white_pts, this._offsetX, this._offsetY/2);
        this._context.fillText("remaining pieces : black : " + black_pieces +"  white : " + white_pieces, this._offsetX+3*this._deltaX, this._offsetY/2);
    }
