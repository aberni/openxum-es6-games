...
class Gui extends OpenXum.Gui {
    ...
    set_canvas(c) {
        ...
        //margin between a piece and the edge of the square
    ...
    _draw_state() {
        this._context.lineWidth = 1;
        this._context.strokeStyle = "#838383";
        let towers = this._engine._towers;
    ...
    _find_piece(x, y) {
        ...
        let k = 0;
        let found = false;
        const towers=this._engine._towers;
    ...
    _on_click(event) {
        //TODO: phase() et verify_move() in engine
        ...
        if (select) {
            ...
            if (coords.x >= 0 && coords.x < 5 && coords.y >= 0 && coords.y < 5) {
                if (!this._selected_piece) {
                    ...
                    this._selected_coordinates = coords;
                    new Mixtour.Move(Mixtour.MoveType.MOVE_TOWER,
