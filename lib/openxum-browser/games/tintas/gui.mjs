...
class Gui extends OpenXum.Gui {
    ...
    _draw_hexagone(x, y){
        ...
        console.log(myColor.convert_to_hexa(this.engine()._board.getCellById(this._coord.length-1).getColor()));
        this._context.fillStyle = myColor.convert_to_hexa(this.engine()._board.getCellById(this._coord.length-1).getColor());
        this._context.beginPath();
