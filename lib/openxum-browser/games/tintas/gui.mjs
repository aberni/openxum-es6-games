...
class Gui extends OpenXum.Gui {
    ...
    _draw_hexagone(x, y){
        ...
        console.log(myColor.convert_to_hexa(this.engine()._board.get_cell_by_id(this._coord.length-1).get_color()));
        this._context.fillStyle = myColor.convert_to_hexa(this.engine()._board.get_cell_by_id(this._coord.length-1).get_color());
        this._context.beginPath();
