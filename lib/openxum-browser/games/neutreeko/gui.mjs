...
class Gui extends OpenXum.Gui {
   ...
   draw() {
    ...
    _draw_selected_piece() {
        let x = this._selected_piece.coordinates().getColumn();
        let y = this._selected_piece.coordinates().getLine();
        ...
        for(let i = 0; i < possible_moves.length; i++) {
            ...
            pt = this._compute_coordinates(move.to().getColumn(), move.to().getLine());
