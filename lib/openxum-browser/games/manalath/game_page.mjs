...
class GamePage extends OpenXum.GamePage {
    ...
    piece_count_changed(white_piece_count, black_piece_count) {
        if (white_piece_count === 0 && GamePage.option_exists(Color.WHITE)) {
            GamePage.remove_option(Color.WHITE);
        } else if (black_piece_count === 0) {
            GamePage.remove_option(Color.BLACK);
        }
    }

    static option_exists(value) {
